/*
 * TDC Database - Seed Data (Corregido para nuevo schema)
 * Inserta datos de prueba compatibles con el nuevo schema
 */
...
INSERT INTO `catalogo_instrumentos` (
    ...
    ('Voz', 'Voz', 'fa-microphone'),
    ('Guitarra Acústica', 'Cuerdas', 'fa-guitar'),
    ('Guitarra Eléctrica', 'Cuerdas', 'fa-guitar'),
    ('Bajo Acústico', 'Cuerdas', NULL),
    ('Bajo Eléctrico', 'Cuerdas', NULL),
    ('Teclados', 'Electrónico', 'fa-keyboard'),
    ('Piano', 'Electrónico', NULL),
    ('Batería', 'Percusión', 'fa-drum'),
    ('Percusión Latina', 'Percusión', NULL),
    ('Violín', 'Cuerdas', NULL),
    ('Cello', 'Cuerdas', NULL),
    ('Flauta', 'Vientos', NULL),
    ('Saxofón', 'Vientos', NULL),
    ('Trompeta', 'Vientos', NULL),
    ('Trombón', 'Vientos', NULL),
    ('Armónica', 'Vientos', NULL),
    ('Acordeón', 'Electrónico', NULL),
    ('Boongos', 'Percusión', NULL),
    ('Congas', 'Percusión', NULL),
    ('Djembe', 'Percusión', NULL),
    ('Caja China', 'Percusión', NULL),
