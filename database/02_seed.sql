...
INSERT INTO `configuracion` (`Clave`, `Valor`) VALUES ('ANTICIPACION_MAXIMA_DIAS','90'),('ANTICIPACION_MINIMA_DIAS','3'),('DIRECCION','Claypole, Buenos Aires'),('EMAIL_CONTACTO','contacto@eltemplodeclaypole.com'),('HORARIO_ATENCION','Lunes a Sábado 10:00 - 22:00'),('NOMBRE_NEGOCIO','El Templo de Claypole'),('TELEFONO','1155551234');
...
INSERT INTO `profesionales_servicios` (`id`, `nombre`, `especialidad`, `telefono`, `email`, `id_cliente`, `dias_trabaja`, `hora_inicio`, `hora_fin`, `activo`, `creado_en`, `actualizado_en`) VALUES (1,'Lucía Martínez','Masajes','1150012345','lucia.m@example.com',NULL,'Lunes,Miércoles,Viernes','09:00:00','17:00:00',1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(2,'Mariana Gómez','Depilación','1150023456','mariana.g@example.com',NULL,'Martes,Jueves','10:00:00','18:00:00',1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(3,'Carolina Ruiz','Estética','1150034567','carolina.r@example.com',NULL,'Lunes a Viernes','09:00:00','17:30:00',1,'2026-02-22 16:16:33','2026-02-22 16:16:33');
...
INSERT INTO `servicios_catalogo` (`id`, `tipo_servicio_id`, `nombre`, `descripcion`, `duracion_minutos`, `activo`, `orden`, `creado_en`, `actualizado_en`) VALUES (1,'MASAJES','Masaje Descontracturante','Masaje descontracturante de 60 minutos',60,1,1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(2,'MASAJES','Masaje Relajante','Masaje relajante de 45 minutos',45,1,2,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(3,'DEPILACION','Depilación Piernas','Depilación con cera - piernas completas',30,1,1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(4,'DEPILACION','Depilación Bozo','Depilación facial - bozo',15,1,2,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(5,'ESTETICA','Limpieza Facial','Limpieza facial profunda de 60 minutos',60,1,1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(6,'ESTETICA','Hidratación Facial','Tratamiento hidratante de 45 minutos',45,1,2,'2026-02-22 16:16:33','2026-02-22 16:16:33');
...
INSERT INTO `bandas_artistas` (`id_banda`, `nombre`, `genero_musical`, `bio`, `instagram`, `facebook`, `twitter`, `tiktok`, `web_oficial`, `youtube`, `spotify`, `otras_redes`, `logo_url`, `foto_prensa_url`, `contacto_nombre`, `contacto_email`, `contacto_telefono`, `contacto_rol`, `verificada`, `activa`, `creado_en`, `actualizado_en`) VALUES (1,'Reite','Rock / Tributo La Renga','Tributo a La Renga con más de 10 años de trayectoria en la zona sur.','@reite.tributo','ReiteOficial',NULL,NULL,NULL,'https://youtube.com/@reitetributo','https://open.spotify.com/artist/reite',NULL,NULL,NULL,'Carlos Pérez','reite.tributo@gmail.com','1155001122','Manager',1,1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(2,'Pateando Bares','Rock Nacional','Rock nacional con temas propios y algunos covers.','@pateando.bares','PateandobaresOk',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'Martín Gómez','pateando.bares@gmail.com','1155003344','Líder',1,1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(3,'Las Mentas','Rock Alternativo','Banda femenina de rock alternativo.','@lasmentas.rock',NULL,NULL,NULL,NULL,'https://youtube.com/@lasmentas','https://open.spotify.com/artist/lasmentas',NULL,NULL,NULL,'Laura Fernández','lasmentas@gmail.com','1155005566','Cantante',1,1,'2026-02-22 16:16:33','2026-02-22 16:16:33'),(4,'Cumbia Sudaka','Cumbia','Cumbia villera con letras sociales.','@cumbiasudaka','CumbiaSudakaOficial',NULL,NULL,NULL,'https://youtube.com/@cumbiasudaka',NULL,NULL,NULL,NULL,'Diego Ramírez','cumbiasudaka@gmail.com','1155009900','Manager',1,1,'2026-02-22 16:16:33','2026-02-22 16:16:33');
...
INSERT INTO `bandas_formacion` (`id`, `id_banda`, `nombre_integrante`, `instrumento`, `es_lider`, `notas`) VALUES (1,1,'Carlos','Guitarra eléctrica',1,'Guitarra líder'),(2,1,'Pablo','Guitarra eléctrica',0,'Guitarra rítmica'),(3,1,'Gustavo','Bajo eléctrico',0,NULL),(4,1,'Chicha','Batería',0,NULL),(5,1,'El Tano','Voz principal',0,NULL),(6,2,'Martín','Guitarra eléctrica',1,'Guitarra y voz'),(7,2,'Martín','Voz principal',0,NULL),(8,2,'Fede','Bajo eléctrico',0,NULL),(9,2,'Nico','Batería',0,NULL),(10,3,'Laura','Voz principal',1,NULL),(11,3,'Camila','Guitarra eléctrica',0,NULL),(12,3,'Sol','Bajo eléctrico',0,NULL),(13,3,'Maia','Batería',0,NULL),(14,3,'Vale','Teclado',0,'Sintetizadores'),(15,4,'Diego','Voz principal',1,NULL),(16,4,NULL,'Teclado',0,NULL),(17,4,NULL,'Guitarra eléctrica',0,NULL),(18,4,NULL,'Bajo eléctrico',0,NULL),(19,4,NULL,'Batería',0,NULL);
...
INSERT INTO `cupones` (`id`, `codigo`, `tipo_descuento`, `valor_fijo`, `porcentaje_descuento`, `usos_maximos`, `usos_actuales`, `fecha_expiracion`, `activo`, `aplica_a`, `fecha_creacion`) VALUES (1,'ROCK20','PORCENTAJE',NULL,20.00,50,0,'2025-12-31',1,'TODAS','2026-02-22 16:16:33'),(2,'DESCUENTO10K','MONTO_FIJO',10000.00,NULL,NULL,0,NULL,1,'ANTICIPADA','2026-02-22 16:16:33'),(3,'PUERTA25','PORCENTAJE',NULL,25.00,100,0,'2025-12-31',1,'PUERTA','2026-02-22 16:16:33');
