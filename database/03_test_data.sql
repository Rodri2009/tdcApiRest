...
INSERT INTO solicitudes (id, categoria, fecha_creacion, estado, descripcion, nombre_solicitante, telefono_solicitante, email_solicitante) VALUES
(1, 'ALQUILER', NOW(), 'Solicitado', 'Cumpleaños de 7 años temático de Minecraft', 'María García', '1155667788', 'maria.garcia@email.com'),
(2, 'ALQUILER', NOW(), 'Solicitado', 'Fiesta de 15 para mi hija Valentina', 'Carlos López', '1144556677', 'carlos.lopez@email.com'),
(3, 'ALQUILER', NOW(), 'Solicitado', 'Almuerzo familiar de fin de año', 'Roberto Fernández', '1133445566', 'roberto.f@email.com'),
(4, 'ALQUILER', NOW(), 'Solicitado', 'Asado familiar de fin de año', 'Ana Martínez', '1122334455', 'ana.m@email.com');

-- Luego insertar en solicitudes_alquiler
INSERT INTO solicitudes_alquiler (id, tipo_de_evento, tipo_servicio, es_publico, fecha_evento, hora_evento, duracion, cantidad_de_personas, precio_basico, nombre_completo, telefono, email, descripcion, estado) VALUES
(1, 'ALQUILER_SALON', 'INFANTILES', 0, '2025-12-20', '15:00', '4 horas', '25', 200000.00, 'María García', '1155667788', 'maria.garcia@email.com', 'Cumpleaños de 7 años temático de Minecraft', 'Solicitado'),
(2, 'ALQUILER_SALON', 'ADOLESCENTES', 0, '2025-12-22', '20:00', '5 horas', '40', 250000.00, 'Carlos López', '1144556677', 'carlos.lopez@email.com', 'Fiesta de 15 para mi hija Valentina', 'Solicitado'),
(3, 'ALQUILER_SALON', 'CON_SERVICIO_DE_MESA', 0, '2025-12-27', '13:00', '4 horas', '30', 240000.00, 'Roberto Fernández', '1133445566', 'roberto.f@email.com', 'Almuerzo familiar de fin de año', 'Solicitado'),
(4, 'ALQUILER_SALON', 'INFORMALES', 0, '2025-12-29', '12:00', '6 horas', '45', 180000.00, 'Ana Martínez', '1122334455', 'ana.m@email.com', 'Asado familiar de fin de año', 'Solicitado');
...
INSERT INTO solicitudes (id, categoria, fecha_creacion, estado, descripcion, nombre_solicitante, telefono_solicitante, email_solicitante) VALUES
(5, 'TALLERES', NOW(), 'Confirmado', 'Taller de Fotografía', 'Juan Pérez', '123456789', 'juan.perez@email.com');

INSERT INTO solicitudes_talleres (id, nombre_taller, fecha_evento, hora_evento, duracion, precio) VALUES
(5, 'Taller de Fotografía', '2026-04-15', '18:00', '2 horas', 1500.00);

-- Nueva solicitud de servicio público confirmada
INSERT INTO solicitudes (id, categoria, fecha_creacion, estado, descripcion, nombre_solicitante, telefono_solicitante, email_solicitante) VALUES
(6, 'SERVICIOS', NOW(), 'Confirmado', 'Servicio de Catering', 'Ana López', '987654321', 'ana.lopez@email.com');

INSERT INTO solicitudes_servicios (id, tipo_servicio, fecha_evento, hora_evento, duracion, precio) VALUES
