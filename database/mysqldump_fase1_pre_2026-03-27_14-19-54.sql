...
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Eventos confirmados unificados';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `solicitudes_alquiler` (
  ...
  `creado_en` timestamp NOT NULL DEFAULT current_timestamp() COMMENT 'NUEVO: Auditoría - Fecha/hora de creación del registro',
  `actualizado_en` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'NUEVO: Auditoría - Fecha/hora de última actualización',
...
CREATE TABLE `solicitudes_fechas_bandas` (
  ...
  `descripcion` text DEFAULT NULL COMMENT 'Descripción del show/evento',
...
INSERT INTO `solicitudes_fechas_bandas` VALUES (4,1,'2026-03-30','22:00','3 horas','Tributo a La Renga - Fecha propia del artista',100000.00,120000.00,100000.00,120000.00,1,'250 personas','[{\"id_banda\":1,\"nombre\":\"Reite\",\"orden_show\":1,\"es_principal\":true}]','Confirmado',NULL,NULL,NULL,'2026-03-13 04:29:21','2026-03-13 04:29:21'),(5,3,'2026-04-10','20:00','2.5 horas','Las Mentas en vivo - Show abierto al público',100000.00,120000.00,100000.00,120000.00,1,'180 personas','[{\"id_banda\":3,\"nombre\":\"Las Mentas\",\"orden_show\":1,\"es_principal\":true}]','Confirmado',NULL,NULL,NULL,'2026-03-13 04:29:21','2026-03-13 04:29:21'),(6,2,'2026-04-18','21:30','4 horas','Bandas metaleras y tributo a Judas Prist',120000.00,120000.00,100000.00,120000.00,3,'120','[{\"id_banda\":29,\"nombre\":\"India Madre\",\"orden_show\":0,\"es_principal\":true},{\"id_banda\":33,\"nombre\":\"KorGue\",\"orden_show\":1,\"es_principal\":false},{\"id_banda\":27,\"nombre\":\"Defensores de la fe\",\"orden_show\":2,\"es_principal\":false}]','Solicitado',NULL,NULL,NULL,'2026-03-13 04:29:21','2026-03-26 19:44:40');
...
-- Dump completed on 2026-03-27 17:19:54
