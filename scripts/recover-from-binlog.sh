...
###############################################################################
# recover-from-binlog.sh - Recupera BD desde Binary Logs de MariaDB
###############################################################################
# Permite restaurar la BD a un punto específico en el tiempo
# 
# USO:
#   ./scripts/recover-from-binlog.sh -t "2026-04-15 14:30:00"   # A un momento específico
#   ./scripts/recover-from-binlog.sh -f mariadb-bin.000042      # Desde un archivo binlog
#   ./scripts/recover-from-binlog.sh -l                         # Listar binlogs disponibles
#   ./scripts/recover-from-binlog.sh -l -v                      # Listar con detalle
###############################################################################
