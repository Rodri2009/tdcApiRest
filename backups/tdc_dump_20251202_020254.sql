...
--
-- Current Database: `tdc_db`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `tdc_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
...
CREATE TABLE `alquiler_salon` (
  ...
  `contrato_url` varchar(512) DEFAULT NULL,
  `privado_notes` text DEFAULT NULL,
  PRIMARY KEY (`event_id`),
  CONSTRAINT `alquiler_salon_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `eventos` (`id`) ON DELETE CASCADE
...
--
-- Table structure for table `bandas_en_vivo`
--

DROP TABLE IF EXISTS `bandas_en_vivo`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `bandas_en_vivo` (
  `event_id` int(11) NOT NULL,
  `nombre_banda` varchar(255) DEFAULT NULL,
  `genero` varchar(100) DEFAULT NULL,
  `promotor` varchar(255) DEFAULT NULL,
  `rider` text DEFAULT NULL,
  `backline_req` text DEFAULT NULL,
  PRIMARY KEY (`event_id`),
  CONSTRAINT `bandas_en_vivo_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `eventos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `bandas_en_vivo`
--

LOCK TABLES `bandas_en_vivo` WRITE;
/*!40000 ALTER TABLE `bandas_en_vivo` DISABLE KEYS */;
INSERT INTO `bandas_en_vivo` VALUES (1,'LA RISA DE CROMO',NULL,NULL,NULL,NULL),(2,'Noche de Jazz Fusión',NULL,NULL,NULL,NULL),(3,'Feria de Diseño y DJ Set',NULL,NULL,NULL,NULL);
/*!40000 ALTER TABLE `bandas_en_vivo` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `cupones` (
  ...
  `aplica_a` enum('TODAS','ANTICIPADA','PUERTA') NOT NULL DEFAULT 'TODAS',
...
INSERT INTO `cupones` VALUES (1,'ROCK20','PORCENTAJE',NULL,20.00,50,0,'2025-12-31',1,'TODAS','2025-11-14 01:59:06'),(2,'A-TODO-O-NADA','MONTO_FIJO',1000.00,NULL,NULL,0,NULL,1,'TODAS','2025-11-14 01:59:06'),(3,'EXPIRADO','PORCENTAJE',NULL,50.00,10,0,'2024-01-01',1,'TODAS','2025-11-14 01:59:06'),(4,'AGOTADO','PORCENTAJE',NULL,15.00,2,2,NULL,1,'TODAS','2025-11-14 01:59:06');
...
CREATE TABLE `eventos` (
  ...
  `activo` tinyint(1) NOT NULL DEFAULT 1,
  `fecha_creacion` timestamp NOT NULL DEFAULT current_timestamp(),
  `tipo_evento` enum('ALQUILER','BANDA','TALLER','DEPILACION','OTRO') NOT NULL DEFAULT 'OTRO',
  `es_publico` tinyint(1) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`),
  KEY `idx_evento_fecha` (`fecha_hora`),
  KEY `idx_eventos_tipo_fecha` (`tipo_evento`,`fecha_hora`),
  KEY `idx_eventos_es_publico_fecha` (`es_publico`,`fecha_hora`)
...
INSERT INTO `eventos` VALUES (1,'LA RISA DE CROMO','2025-12-05 21:00:00',5000.00,5000.00,5000.00,150,'Noche de rock alternativo con teloneros invitados. Apertura 21h.',1,'2025-11-14 01:59:06','BANDA',1),(2,'Noche de Jazz Fusión','2025-12-12 20:30:00',3500.00,3500.00,3500.00,80,'Show acústico íntimo del Ensamble Claypole Jazz.',1,'2025-11-14 01:59:06','BANDA',1),(3,'Feria de Diseño y DJ Set','2025-12-20 18:00:00',0.00,0.00,0.00,200,'Evento gratuito con reserva. Entrada libre y musicalización a cargo de DJ Clay.',1,'2025-11-14 01:59:06','BANDA',1);
...
CREATE TABLE `servicios` (
  ...
  `sesiones_requeridas` int(11) DEFAULT NULL,
  `intervalo_meses` int(11) DEFAULT NULL,
  `profesional_id` int(11) DEFAULT NULL,
  `notas` text DEFAULT NULL,
  PRIMARY KEY (`event_id`),
  CONSTRAINT `servicios_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `eventos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `solicitudes_adicionales` VALUES ('2025-10-01 00:00:00',5,'Manteles negros sólos',20000.00),('2025-11-21 05:36:51',13,'Inflable Cocodrilo',30000.00);
...
--
-- Table structure for table `talleres_actividades`
--

DROP TABLE IF EXISTS `talleres_actividades`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `talleres_actividades` (
  `event_id` int(11) NOT NULL,
  `instructor` varchar(255) DEFAULT NULL,
  `cupo` int(11) DEFAULT NULL,
  `duracion_hs` int(11) DEFAULT NULL,
  `materiales_incluidos` text DEFAULT NULL,
  `precio_por_participante` decimal(10,2) DEFAULT NULL,
  PRIMARY KEY (`event_id`),
  CONSTRAINT `talleres_actividades_ibfk_1` FOREIGN KEY (`event_id`) REFERENCES `eventos` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `talleres_actividades`
--

LOCK TABLES `talleres_actividades` WRITE;
/*!40000 ALTER TABLE `talleres_actividades` DISABLE KEYS */;
/*!40000 ALTER TABLE `talleres_actividades` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tickets` (
  ...
  `tipo_precio` enum('ANTICIPADA','PUERTA','OTRO') NOT NULL DEFAULT 'ANTICIPADA',
...
INSERT INTO `usuarios` VALUES (1,'villalbarodrigo2009@gmail.com','$2b$10$olHaOd9Hay25piLUhcU4z.VvKOJMuwQbgYzUQh5oSrmVaZe13M.by','Administrador','admin','2025-11-28 22:45:05');
...
-- Dump completed on 2025-12-02  5:02:54
